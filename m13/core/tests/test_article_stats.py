            ...
            "content": [
                {
                    ...
                    "profit_after_taxes": Decimal("-5.46"),
                    "return_costs": Decimal("3.55"),
                    "returned": 1,
                    "sales": Decimal("0.00"),
                    "shipped": 0,
                    "shipping_costs": Decimal("3.55"),
                    "total_diff": Decimal("-2.48"),
                    "total_return_costs": Decimal("7.94"),
                    "total_revenue": Decimal("5.46"),
    ...
    assert stats == {
        "Woman Bomber Jacken": {
            "content": [
                {
                    ...
                    "shipped": 5,
                    "shipping_costs": Decimal("3.55"),
                    "total_diff": Decimal("-32.26"),
                    "total_return_costs": Decimal("15.88"),
                    "total_revenue": Decimal("-16.38"),
                    "vk_zalando": Decimal("27.95"),
                },
                {
                    "article_number": "women-bom-na-s",
                    ...
                    "profit_after_taxes": Decimal("-8.49"),
                    "return_costs": Decimal("3.55"),
                    "returned": 0,
                    "sales": Decimal("47.90"),
                    "shipped": 2,
                    "shipping_costs": Decimal("3.55"),
                    "total_diff": Decimal("-16.98"),
                    "total_return_costs": Decimal("0.00"),
                    "total_revenue": Decimal("-16.98"),
            ...
            "stats": {
                ...
                "shipped": 7,
                "total_diff": Decimal("-49.24"),
                "total_return_costs": Decimal("15.88"),
                "total_revenue": Decimal("-33.36"),
            },
        }
    }
