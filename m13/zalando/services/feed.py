...
price_overwrites = [
    ...
    ("69,95", "79,95", "women-bom-vi-xs"),
    ("69,95", "79,95", "women-bom-vi-s"),
    ("69,95", "79,95", "women-bom-vi-m"),
    ("69,95", "79,95", "women-bom-vi-l"),
    ("69,95", "79,95", "women-bom-vi-xl"),
    ("29,95", "34,95", "RKS001"),
    ("29,95", "34,95", "RKS004"),
...
def pimp_prices(lines):
    ...
    overwrites = {}
    for entry in price_overwrites:
        price = entry[0]
        retail_price = entry[1]
        sku = entry[2]
        overwrites[sku] = {
            "price": price,
    ...
    for current_row in lines[1:]:
        ...
        retail_price = None
        if row.article_number in overwrites:
            price = overwrites[row.article_number]["price"]
            retail_price = overwrites[row.article_number]["retail_price"]
        ...
        if retail_price is not None:
            row.retail_price = str(retail_price)
        else:
