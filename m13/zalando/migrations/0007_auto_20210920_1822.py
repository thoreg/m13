    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ASSIGNED', 'Assigned'), ('FULFILLED', 'Fulfilled'), ('ROUTED', 'Routed'), ('CANCELLED', 'Cancelled'), ('RETURNED', 'Returned')], default='ASSIGNED', max_length=11)),
                ('delivery_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='delivery_address_set', to='zalando.address')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='zalando.order')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
