...
MIRAPODO_URLS = ["mirapodo_index", "mirapodo_orderitems_csv"]
    ...
    assert [o for o in orders] == [
        {
            ...
            "order_date": datetime.datetime(
                2022, 9, 2, 7, 16, 1, tzinfo=datetime.timezone.utc
            ),
        },
        {
            "created": datetime.datetime(
            ...
            "order_date": datetime.datetime(
                2022, 9, 4, 19, 45, 43, tzinfo=datetime.timezone.utc
            ),
        },
    ]
    ...
    assert [o for o in Order.objects.all().values()] == [
        {
            ...
            "order_date": datetime.datetime(
                2021, 5, 7, 10, 32, 8, tzinfo=datetime.timezone.utc
            ),
        }
    ]
