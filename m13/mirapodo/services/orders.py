"""
https://rest.trade-server.net/3247/orders/405
Benutzername: apiusuer
Händlernummer: 3247
PW: aWKGyy6w
...
def import_order(order_dict):
    ...
    address_data = order_dict['SHIP_TO']
...
def fetch_orders():
    ...
    for tb_id in range(1, 408):
        ...
        try:
            ...
            with open(f'order_{tb_id}.xml', mode='wb') as localfile:
