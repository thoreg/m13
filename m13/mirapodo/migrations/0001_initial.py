    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_address', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='delivery_address_set', to='mirapodo.address')),
                ('invoice_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='invoice_address_set', to='mirapodo.address')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
